        ...
        <Section id="about" className="bg-white relative z-10">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                    <h2 className="text-4xl md:text-5xl font-bold text-aerulaBlue-700 tracking-tight">
                ...
                <div className="bg-aerulaBlue-50 rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden shadow-inner border border-aerulaBlue-100">
                    <div className="relative z-10">
                        <h3 className="text-2xl font-bold text-aerulaBlue-700 mb-6">Our Promise</h3>
                        <ul className="space-y-5">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-4">
                                    <span className="w-8 h-8 rounded-full bg-aerulaBlue-500 flex items-center justify-center text-white text-sm font-bold flex-shrink-0 shadow-md">
                                        {i + 1}
                                    </span>
                    ...
                    {/* Decorative blob */}
                    <div className="absolute -bottom-24 -right-24 w-80 h-80 bg-aerulaBlue-100 rounded-full blur-3xl opacity-60"></div>
                </div>
            </div>
        </Section>
    );
